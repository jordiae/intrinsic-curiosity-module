...
if __name__ == '__main__':
    ...
    parser.add_argument('--early-stop', type=int,
                        help='Episode patience in early stop (-1 -> no early stop)', default=10)
    ...
    parser.add_argument('--conv-layers', type=int, help='Number of convolutional layers', default=1)
    parser.add_argument('--fc-layers', type=int, help='Number of fully-connected layers', default=1)
    ...
    parser.add_argument('--icm-state-features', type=int, help='Curiosity module state feature size',
                        default=1024)
